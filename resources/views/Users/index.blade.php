                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <div class="invalid-tooltip"
                                        v-if="errors.fechaNacimiento">@{{ errors.fechaNacimiento }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Apellido*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.apellido">@{{ editErrors.apellido }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Genero*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.genero">@{{ editErrors.genero }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Usuario*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.usuario">@{{ editErrors.usuario }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
            ...
            validateEditDate() {
                ...
                if (date > today) {
                    this.editErrors.fechaNacimiento =
                        'La fecha de nacimiento no puede ser mayor a la fecha actual';
                    document.getElementById('fechaNacimientoEdit').setAttribute('class', 'form-control is-invalid');
                } else {
                    document.getElementById('fechaNacimientoEdit').setAttribute('class', 'form-control is-valid');
                }
