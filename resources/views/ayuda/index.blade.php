            ...
            <div class="card-body" style="text-align: justify;">
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Empresa" aria-expanded="false"
                        ...
                        <h4> <i class="fa-solid fa-briefcase"></i> Empresa</h4>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Roles" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-image-portrait"></i> Roles</h4>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Permisos" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-key"></i> Permisos</h4>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Parametros" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-gear"></i> Parametros</h4>
                    ...
                    <div class="collapse" id="Parametros">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span> Los parametros son las configuraciones que se le pueden realizar al sistema para
                                adaptarlo a
                                las necesidades
                                de la empresa.</span>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Unidades" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-ruler-horizontal"></i> Unidades</h4>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Categorias" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-tags"></i> Categorias</h4>
                    ...
                    <div class="collapse" id="Categorias">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span> Las categorias de los productos son las clasificaciones que se le asignan a los
                                productos,
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Cajas" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-cash-register"></i> Cajas</h4>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Estados" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-toggle-on"></i> Estados</h4>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Inventario" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-warehouse"></i> Inventario</h4>
                    ...
                    <div class="collapse" id="Inventario">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span> El inventario es el registro de los productos que se tienen en existencia, asi como
                                tambien
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="collapse" id="Clientes">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span>Al modificar un cliente, los cambios se veran reflejados en las transacciones futuras al
                                cliente</span>
                            ...
                            <p class="text-danger">Al eliminar un cliente, las ventas asociadas no se perderan, pero se
                                perdera la informacion
                                del cliente.</span>
                            ...
                            <span class="text-danger">El descuento se aplica al total de la venta, esto puede afectar el
                                valor final de la transaccione
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Proveedores"
                        ...
                        <h4><i class="fa-solid fa-truck"></i> Proveedores</h4>
                    ...
                    <div class="collapse" id="Proveedores">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            <h4>Inicio</h4>
                            <span>En esta sección se podrá visualizar la información de los proveedores, modificar,
                                registrar
                                y eliminar proveedores.</span>



                            <span> Los proveedores son las personas o empresas que suministran los productos al sistema,
                                estos se asocian a los productos que ofrecen
                                y permiten tener un control sobre los precios y productos que le ofrecen cada
                                proveedor</span>
                            ...
                            <span>Para modificar la información de los proveedores, se deberá hacer clic en el botón
                                "Editar"
                            ...
                            <span>Al modificar un proveedor, los cambios se veran reflejados en las transacciones futuras al
                                proveedor</span>

                            <br><br>
                            <h4>Eliminar Proveedor</h4>
                            <span>Para eliminar un proveedor, se deberá hacer clic en el botón "Eliminar" con un icono de
                                una
                            ...
                            <p class="text-danger">Al eliminar un proveedor, las compras asociadas o productos no se
                                perderan, pero se perdera la informacion
                                del proveedor.</span>
                            <p class="text-danger">Al desactivar un proveedor, este no se mostrara en la lista de opciones
                                al comprar o crear productos, pero
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="collapse" id="Productos">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <h4>Inicio</h4>
                            <span>En esta sección se podrá visualizar la información de los productos, modificar, registrar
                                y
                            ...
                            <span> Los productos son los elementos que se venden en el sistema, estos productos se asocian a
                                categorias, unidades de medida, estados y proveedores, para llevar un control de los
                                productos
                            ...
                            <span>Para modificar la información de los productos, se deberá hacer clic en el botón "Editar"
                                con
                            ...
                            <span>Al modificar un producto, los cambios se veran reflejados en las transacciones futuras al
                                producto</span>

                            <br><br>
                            <h4>Eliminar Producto</h4>

                            <span class="text-danger">Un producto no puede ser eliminado directamente, pero si puede ser
                                inactivado. Esto es debido a politicas de auditoria e historial legal</span>


                            <br><br>
                            <h4>¿Tengo demasiados productos inactivos y me gustaria eliminarlos?</h4>
                            <span>Si tiene demasiados productos inactivos y desea eliminarnos, lastimosamente no es posible
                                eliminarlos por completo, debido a politicas de auditoria e historial legal.</span>
                            <span>Sin embargo el sistema se encarga de enlistar de ultimo los productos inactivos, para que
                                no interfieran con los productos activos.</span>
                            <span>Si desea eliminar un producto inactivo, se recomienda cambiar el estado del producto a
                                "Inactivo" para que no se muestre en las listas de productos activos.</span>

                            <br><br>
                            <h4>¿Que pasa al inactivar un producto?</h4>
                            <span>Al inactivar un producto, este no se mostrara en la lista de opciones al comprar o vender
                                productos, pero las ventas y compras asociadas no se perderan.</span>
                            <span>Tampoco se tomara en cuenta en los reportes de inventario, conteo de productos, calculos
                                de stock, calculos de valor de inventario, kardex o lotes.</span>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Lotes" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-cart-flatbed"></i> Lotes</h4>
                    ...
                    <div class="collapse" id="Lotes">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span> Los lotes son los grupos de productos que se venden en el sistema, estos lotes se asocian
                                a
                                productos, y son considerados en conjunto como su stock. Esto permite llevar un control de
                                los
                            ...
                            <span>Para registrar un nuevo lote, debe de realizar un compra del producto que desee registrar
                                como lote, y al momento de registrar la compra, se le pedira que ingrese la fecha de
                                vencimiento
                            ...
                            <span> Para poder ingresar multiples lotes de un producto, se debera de realizar multiples
                                compras
                                del mismo producto, con diferentes fechas de vencimiento y cantidad de productos.</span>

                            <br><br>
                            <h4>Modificar Lote</h4>
                            <span>Para modificar la información de los lotes, se deberá hacer desde la pantalla de
                                productos,
                            ...
                            <span>Una vez hecho clic en el boton de lotes, se mostrará una lista de los lotes del producto,
                                con la cantidad, fecha de vencimiento y opciones para modificar la fecha de vencimiento de
                                un producto.</span>
                            ...
                            <span>Un lote inactivo no puede ser modificado, ni vendido, ni comprado, ni movido, ni
                                eliminado,
                                pero se mantiene en el sistema por razones de historial y auditoria.</span>

                            <span> Sin embargo, los lotes estan asociados a un inventario, por lo que al cerrar un
                                inventario,
                                los lotes inactivos no se tomaran en cuenta en los calculos de stock, valor de inventario,
                                kardex o reportes.</span>

                            <span> Simplemente, pasaran a ser parte del nuevo inventario activo y no se mostraran en la
                                pantalla de lotes de productos, pero
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Compras" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-basket-shopping"></i> Compras</h4>
                    ...
                    <div class="collapse" id="Compras">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span> Las compras son las transacciones de productos que se realizan en el sistema, estas
                                compras permiten ingresar producto
                                al sistema, se diferencian de los movimientos de entrada de Kardex, ya que las compras son
                                transacciones de productos y
                            ...
                            <span>
                                En este apartado se le presenta la opcion de modificar el precio de compra y el proveedor en
                                caliente, es decir, al momento de
                                registrar la compra, sin embargo, debe tener en cuenta que si modifica estos valores, seran
                                modificados y se veran reflejados en el producto y en el proveedor
                                en las transacciones futuras.
                            </span>

                            <br><br>
                            <h4>Modificar Compra</h4>
                            <span>Pronto se agregara la funcion de establecer una compra como pendiente de pago, lo que
                                permitira
                                modificar la compra despues de haberla registrado.</span>
                            <span class="text-danger">Por el momento, no es posible modificar una compra despues de haberla
                                registrado, por lo que se recomienda
                                revisar bien los datos antes de registrar la compra.</span>

                            <span> Tip: Puede escribir en la barra de busqueda de productos la cantidad seguido de 'x' o '*'
                                y el codigo del producto,
                                para agregar multiples productos a la compra.

                                Por ejemplo: 5x00001 o 5*00001, agregara 5 productos del producto con codigo 00001 a la
                                compra.
                            </span>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#Kardex" aria-expanded="false"
                        ...
                        <h4><i class="fa-solid fa-arrow-right-arrow-left"></i> Kardex</h4>
                    ...
                    <div class="collapse" id="Kardex">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span> Tip: Puede escribir en la barra de busqueda de productos la cantidad seguido de 'x' o '*'
                                ...
                                Por ejemplo: 5x00001 o 5*00001, agregara 5 productos del producto con codigo 00001 al
                                movimiento.
                            </span>
                            ...
                            <span>Las entradas de stock son los movimientos de productos que se compran o ingresan al
                                sistema,
                                y las salidas de stock son los movimientos de productos que se venden o salen del
                                sistema.</span>



                            <span> Los movimientos de entrada se registraran al lote mas reciente registrado y activo que
                                este asociado al sistema.</span>
                            <span> Los movimientos de salida se registraran al lote mas antiguo registrado y activo que este
                                asociado al sistema.</span>

                            <br>
                            <h5 class="text-danger"> Si no hay lotes registrados o activos, no se podra realizar
                                movimientos de stock.</h4>

                                <br><br>
                                <h4>¿Para que sirve el Kardex?</h4>
                                <span>El Kardex sirve para llevar un control de los movimientos de stock de los productos,
                                    asi como
                                    tambien los movimientos de valor de inventario, entradas y salidas de productos, y el
                                    stock
                                    disponible de los productos.</span>

                                <br><br>
                                <h4>¿Que pasa si no registro un movimiento de stock?</h4>
                                <span>Si no registra un movimiento de stock, el sistema no podra llevar un control de los
                                    productos
                                    y transacciones realizadas en el sistema, lo que puede generar confusion en los reportes
                                    y
                                    documentos generados por el sistema.</span>

                                <br><br>
                                <h4>¿Que pasa si registro un movimiento de stock incorrecto?</h4>
                                <span>Si registra un movimiento de stock incorrecto, se recomienda corregir el movimiento de
                                    stock
                                    para llevar un control adecuado de los mismos, y evitar confusion en los reportes y
                                    documentos
                                    generados por el sistema.</span>

                                <span> Si ingresa o da salida a demasiados productos, puede realizar un movimiento de stock
                                    contrario para corregir el error.</span>



                                <span class="text-danger"> Nota: Los movimientos de stock no se pueden eliminar, pero si se
                                    pueden modificar para corregir errores.</span>
                ...
                <div class="card hoverCard" style="margin-bottom: 10px;">
                    ...
                    <div class="card-title" data-bs-toggle="collapse" data-bs-target="#EnviarCorreo"
                        aria-expanded="false" aria-controls="EnviarCorreo"
                        style="display: flex; justify-content: space-between; padding-left: 15px; padding-right: 15px; padding-top: 10px; cursor: pointer;">

                        <h4><i class="fa-solid fa-circle-question"></i> ¿Necesita mas ayuda o tiene sugerencias?</h4>
                    ...
                    <div class="collapse" id="EnviarCorreo">
                        ...
                        <div class="card-body" style="padding-top: 1px;">
                            ...
                            <span>En el correo deberá de especificar la sección del sistema con la que necesita ayuda, y
                                detallar el problema o duda que tenga con esa sección. Si es posible incluya capturas de
                                pantalla
                            ...
                            <span>Si tiene alguna sugerencia que desee que se pueda implementar al sistema, escuchamos sus
                            ...
                            <span>En el correo deberá de especificar la sugerencia que desea que se implemente al sistema, y
                                detallar la sugerencia o mejora que desea que se realice. Si es posible incluya capturas de
                                pantalla
