...
<div id="app">
    ...
    <div class="modal fade" id="nuevaCompraModal" tabindex="-1" aria-labelledby="nuevaCompraLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl modal-fullscreen-lg-down" style="min-width: 95%;">
                            ...
                            <table ref="table" class="table table-hover" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="producto in productosCompra" :key="producto.id">
                                        ...
                                        <td><input type="number" class="form-control" v-model="producto.stockMaximo" disabled></td>
                                        <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" v-model="codigoCompra"
                                        placeholder="Codigo o numero de Factura" style="margin-bottom: 10px;" maxlength="24">
                                </div>
                                <!-- Fecha de compra -->
                                <div class="col-12">
