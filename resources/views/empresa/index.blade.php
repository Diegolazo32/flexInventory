                        ...
                        <div class="col-lg-4"
                            ...
                            <dvi>
                                <img src="{{ asset('storage/logo/logo_empresa.jpg') }}" alt="Logo de la empresa"
                                    style=" height: 250px; width: 250px; border-radius: 15px; margin-bottom: 20px;">
                            </dvi>
                            <div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                        placeholder="Nombre" @keyup="validateForm"
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="telefono" name="telefono"
                                        ...
                                        @keyup="validateForm" v-model="empresa.telefono">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="NIT" name="NIT"
                                        placeholder="NIT de la empresa" @keyup="validateForm"
                                        v-model="empresa.NIT">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="NRC" name="NRC"
                                        placeholder="NRC de la empresa" @keyup="validateForm"
                                        v-model="empresa.NRC">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="giro" name="giro"
                                        placeholder="Giro de la empresa" @keyup="validateForm"
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <div class="invalid-tooltip" v-if="errors.nitRepresentante">@{{ errors.nitRepresentante }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="telefonoRepresentante"
                                        ...
                                        placeholder="Telefono del representante" @keyup="validateForm"
                                        v-model="empresa.telefonoRepresentante">
                            ...
                            <div class="form col-lg-6" style="margin-bottom: 10px;">
                                <input type="file" class="form-control" id="logo" name="logo"
                                    placeholder="Logo de la empresa" @keyup="validateForm"
        ...
        methods: {
            ...
            validateForm() {
                ...
                if (!this.empresa.nitRepresentante) {
                    ...
                    document.getElementById('nitRepresentante').setAttribute('class', 'form-control is-invalid');
                } else {
