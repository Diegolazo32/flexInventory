                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <div class="invalid-tooltip"
                                        v-if="errors.emailPrincipal">@{{ errors.emailPrincipal }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <div class="invalid-tooltip"
                                        v-if="errors.telefonoPrincipal">@{{ errors.telefonoPrincipal }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <div class="invalid-tooltip"
                                        v-if="errors.representante">@{{ errors.representante }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <div class="invalid-tooltip"
                                        v-if="errors.emailRepresentante">@{{ errors.emailRepresentante }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <div class="invalid-tooltip"
                                        v-if="errors.telefonoRepresentante">@{{ errors.telefonoRepresentante }}</div>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Direccion*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.direccion">@{{ editErrors.direccion }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                            ...
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Email Principal*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.emailPrincipal">@{{ editErrors.emailPrincipal }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Telefono Principal*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.telefonoPrincipal">@{{ editErrors.telefonoPrincipal }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Representante*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.representante">@{{ editErrors.representante }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Email Representante*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.emailRepresentante">@{{ editErrors.emailRepresentante }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">Telefono Representante*</label>
                                    <div class="invalid-tooltip"
                                        v-if="editErrors.telefonoRepresentante">@{{ editErrors.telefonoRepresentante }}</div>
                                </div>
                            </div>
                            <div class="form-floating col-lg-6" style="margin-bottom: 10px;">
                                <div class="form-floating mb-3">
        ...
        methods: {
            ...
            validateForm() {
                ...
                if (!this.item.telefonoPrincipal) {
                    ...
                    document.getElementById('telefonoPrincipal').setAttribute('class', 'form-control is-invalid');
                } else {
                ...
                if (!this.item.emailRepresentante) {
                    ...
                    document.getElementById('emailRepresentante').setAttribute('class', 'form-control is-invalid');
                } else {
                    document.getElementById('emailRepresentante').setAttribute('class', 'form-control is-valid');
                }

                if (!this.item.telefonoRepresentante) {
                    this.errors.telefonoRepresentante = 'Este campo es obligatorio';
                    document.getElementById('telefonoRepresentante').setAttribute('class', 'form-control is-invalid');
                } else {
                    document.getElementById('telefonoRepresentante').setAttribute('class', 'form-control is-valid');
                }
            ...
            validateEditForm() {
                ...
                if (!this.editItem.emailPrincipal) {
                    ...
                    document.getElementById('emailPrincipalEdit').setAttribute('class', 'form-control is-invalid');
                } else {
                    document.getElementById('emailPrincipalEdit').setAttribute('class', 'form-control is-valid');
                }

                if (!this.editItem.telefonoPrincipal) {
                    this.editErrors.telefonoPrincipal = 'Este campo es obligatorio';
                    document.getElementById('telefonoPrincipalEdit').setAttribute('class', 'form-control is-invalid');
                } else {
                    document.getElementById('telefonoPrincipalEdit').setAttribute('class', 'form-control is-valid');
                }

                if (!this.editItem.representante) {
                    this.editErrors.representante = 'Este campo es obligatorio';
                    document.getElementById('representanteEdit').setAttribute('class', 'form-control is-invalid');
                } else {
                ...
                if (!this.editItem.emailRepresentante) {
                    ...
                    document.getElementById('emailRepresentanteEdit').setAttribute('class', 'form-control is-invalid');
                } else {
                    document.getElementById('emailRepresentanteEdit').setAttribute('class', 'form-control is-valid');
                }

                if (!this.editItem.telefonoRepresentante) {
                    this.editErrors.telefonoRepresentante = 'Este campo es obligatorio';
                    document.getElementById('telefonoRepresentanteEdit').setAttribute('class', 'form-control is-invalid');
                } else {
                    document.getElementById('telefonoRepresentanteEdit').setAttribute('class', 'form-control is-valid');
                }
