                                ...
                                <div class="form-floating col-lg-12" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <textarea type="text-area" class="form-control" id="descripcion" name="descripcion" style="height: 100px;"
                                            placeholder="Descripcion" @blur="validateForm" @keyup="validateForm" v-model="item.descripcion"></textarea>
                                ...
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="precioDescuento"
                                            ...
                                            @keyup="validateForm" v-model="item.precioDescuento" step="0.01"
                                            min="0" max="999999" maxlength="6">
                                        <label for="floatingInput">Precio Descuento</label>
                                        <div class="invalid-tooltip" v-if="errors.precioDescuento">@{{ errors.precioDescuento }}
                                        </div>
                                    </div>
                                </div>
                                <!-- Precio Especial -->
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="precioEspecial"
                                            ...
                                            @keyup="validateForm" v-model="item.precioEspecial" step="0.01"
                                            min="0" max="999999" maxlength="6">
                                        <label for="floatingInput">Precio Especial</label>
                                        <div class="invalid-tooltip" v-if="errors.precioEspecial">@{{ errors.precioEspecial }}
                                        </div>
                                    </div>
                                </div>
                                <!-- Fecha Vencimiento -->
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="date" class="form-control" id="fechaVencimiento"
                                            ...
                                            @keyup="validateForm" v-model="item.fechaVencimiento">
                                        <label for="floatingInput">Fecha Vencimiento</label>
                                        <div class="invalid-tooltip" v-if="errors.fechaVencimiento">
                                            @{{ errors.fechaVencimiento }}</div>
                                    </div>
                                </div>
                                <!-- Stock -->
                                ...
                                <div class="form-floating col-lg-2" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="stockMinimo" name="stockMinimo"
                                            placeholder="Stock Minimo" @blur="validateForm" @keyup="validateForm"
                                            v-model="item.stockMinimo" step="1" min="0" max="999999"
                                            maxlength="6">
                                        <label for="floatingInput">Stock Minimo</label>
                                        <div class="invalid-tooltip" v-if="errors.stockMinimo">@{{ errors.stockMinimo }}
                                        </div>
                                    </div>
                                </div>
                                <!-- Stock Maximo -->
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="stockMaximo" name="stockMaximo"
                                            placeholder="Stock Maximo" @blur="validateForm" @keyup="validateForm"
                                            v-model="item.stockMaximo" step="1" min="0" max="999999"
                                            maxlength="6">
                                        <label for="floatingInput">Stock Maximo</label>
                                        <div class="invalid-tooltip" v-if="errors.stockMaximo">@{{ errors.stockMaximo }}
                                        </div>
                                    </div>
                                </div>
                                <!-- Categoria -->
                            ...
                            <div class="col-lg-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch"
                                        id="flexSwitchCheckDefault" v-model="multiples">
                                    <label class="form-check-label" for="flexSwitchCheckDefault">Multiples</label>
                                </div>
                            </div>
                            <div class="col-lg-6" style="display: flex; justify-content: end; gap: 5px;">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                    id="cancelButton" @click="cleanForm">Cancelar</button>
                            ...
                            <div class="row">
                                ...
                                <div class="form-floating col-lg-4" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingInput">Descripcion</label>
                                        <div class="invalid-tooltip" v-if="editErrors.descripcion">
                                ...
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="precioDescuentoEdit"
                                            ...
                                            v-model="editItem.precioDescuento" step="0.01" min="0"
                                            max="999999" maxlength="6">
                                        <label for="floatingInput">Precio Descuento</label>
                                        <div class="invalid-tooltip" v-if="editErrors.precioDescuento">
                                            @{{ editErrors.precioDescuento }}</div>
                                    </div>
                                </div>
                                <!-- Precio Especial -->
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="precioEspecialEdit"
                                            ...
                                            @keyup="validateEditForm" v-model="editItem.precioEspecial" step="0.01"
                                            min="0" max="999999" maxlength="6">
                                        <label for="floatingInput">Precio Especial</label>
                                        <div class="invalid-tooltip" v-if="editErrors.precioEspecial">
                                            @{{ editErrors.precioEspecial }}</div>
                                    </div>
                                </div>
                                <!-- Fecha Vencimiento -->
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input disabled type="date" class="form-control" id="fechaVencimientoEdit"
                                            ...
                                            @blur="validateEditForm" @keyup="validateEditForm"
                                            v-model="editItem.fechaVencimiento">
                                        <label for="floatingInput">Fecha Vencimiento</label>
                                        <div class="invalid-tooltip" v-if="editErrors.fechaVencimiento">
                                            @{{ editErrors.fechaVencimiento }}</div>
                                    </div>
                                </div>
                                <!-- Stock -->
                                <div class="form-floating col-lg-2" style="margin-bottom: 10px;">
                                ...
                                <div class="form-floating col-lg-2" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="stockMinimoEdit"
                                            ...
                                            @keyup="validateEditForm" v-model="editItem.stockMinimo" step="1"
                                            min="0" max="999999" maxlength="6">
                                        <label for="floatingInput">Stock Minimo</label>
                                        <div class="invalid-tooltip" v-if="editErrors.stockMinimo">
                                            @{{ editErrors.stockMinimo }}
                                        </div>
                                    </div>
                                </div>
                                <!-- Stock Maximo -->
                                <div class="form-floating col-lg-3" style="margin-bottom: 10px;">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="stockMaximoEdit"
                                            ...
                                            @keyup="validateEditForm" v-model="editItem.stockMaximo" step="1"
                                            min="0" max="999999" maxlength="6">
                                        <label for="floatingInput">Stock Maximo</label>
                                        <div class="invalid-tooltip" v-if="editErrors.stockMaximo">
                                            @{{ editErrors.stockMaximo }}
                                        </div>
                                    </div>
                                </div>
                                <!-- Categoria -->
                ...
                <div class="modal-content">
                    <div class="modal-header row" style="display: flex; justify-content: space-between;">
                        <div class="col-lg-6">
                            ...
                            <small class="text-muted">Aqui puede modificar la fecha de vencimiento de un
                                lote</small><br>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                            id="cancelLotesButton" @click="cleanForm">Cerrar</button>
            ...
            methods: {
                ...
                validateEditForm() {
                    ...
                    if (!this.editItem.precioCompra) {
                        ...
                        document.getElementById('precioCompraEdit').setAttribute('class',
                    ...
                    if (this.editItem.precioDescuento < 0) {
                        ...
                        document.getElementById('precioDescuentoEdit').setAttribute('class',
                            'form-control is-invalid');
                    } else {
                        document.getElementById('precioDescuentoEdit').setAttribute('class',
                    ...
                    if (this.editItem.precioEspecial < 0) {
                        ...
                        document.getElementById('precioEspecialEdit').setAttribute('class',
                            'form-control is-invalid');
                    } else {
                        document.getElementById('precioEspecialEdit').setAttribute('class',
                            'form-control is-valid');
                    ...
                    if (!this.editItem.stockInicial) {
                        ...
                        document.getElementById('stockInicialEdit').setAttribute('class',
                            'form-control is-invalid');
                ...
                validateEditDate(date) {
                    ...
                    if (!date) {
                        document.getElementById('fechaVencimientoEdit').setAttribute('class',
                            'form-control is-valid');
                        return;
                    }
                ...
                validateDate(date) {
                    ...
                    if (fecha < hoy) {
                        this.errors.fechaVencimiento =
                            'La fecha de vencimiento no puede ser menor o igual a la fecha actual';
                        document.getElementById('fechaVencimiento').setAttribute('class',
                            'form-control is-invalid');
                    } else {
                        document.getElementById('fechaVencimiento').setAttribute('class', 'form-control is-valid');
                    }
